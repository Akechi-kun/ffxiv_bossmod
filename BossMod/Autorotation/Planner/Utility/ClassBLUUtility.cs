...
public sealed class ClassBLUUtility(RotationModuleManager manager, Actor player) : RoleCasterUtility(manager, player)
{
    ...
    {
        var res = new RotationModuleDefinition("Utility: BLU", "Planner support for utility actions\nNOTE: There are a lot of Utility actions for Blue Mage.\nFor better accessibility:\n  1. Select 'Column Visibility' tab\n  2. Choose which skills you would like to keep visible or invisible", "Cooldown Planner|Utility", "Akechi", RotationModuleQuality.Basic, BitMask.Build((int)Class.BLU), 80);
        DefineShared(res, IDLimitBreak3);

        DefineSimpleGCD(res, Track.Bristle, "Bristle", "Bristle", 100, BLU.AID.Bristle, 30);
        DefineSimpleGCD(res, Track.WhiteWind, "White Wind", "W.Wind", 100, BLU.AID.WhiteWind);
        DefineSimpleGCD(res, Track.IceSpikes, "Ice Spikes", "I.Spikes", 50, BLU.AID.IceSpikes, 15);
        DefineSimpleGCD(res, Track.OffGuard, "Off Guard", "OffG.", 25, BLU.AID.OffGuard, 15);
        DefineSimpleGCD(res, Track.Transfusion, "Transfusion", "Transf.", 10, BLU.AID.Transfusion);
        DefineSimpleGCD(res, Track.Diamondback, "Diamondback", "D.back", 100, BLU.AID.Diamondback, 10);
        DefineSimpleGCD(res, Track.MightyGuard, "Mighty Guard", "MightyG.", 10, BLU.AID.MightyGuard);
        DefineSimpleGCD(res, Track.ToadOil, "Toad Oil", "T.Oil", 10, BLU.AID.ToadOil, 180);
        DefineSimpleGCD(res, Track.MoonFlute, "Moon Flute", "MoonFlute", 100, BLU.AID.MoonFlute, 15);
        DefineSimpleGCD(res, Track.PeculiarLight, "Peculiar Light", "P.Light", 25, BLU.AID.PeculiarLight, 15);
        DefineSimpleGCD(res, Track.VeilOfTheWhorl, "Veil Of The Whorl", "V.Whorl", 100, BLU.AID.VeilOfTheWhorl, 30);
        DefineSimpleGCD(res, Track.EerieSoundwave, "Eerie Soundwave", "Soundwave", 100, BLU.AID.EerieSoundwave);
        DefineSimpleGCD(res, Track.PomCure, "Pom Cure", "PomCure", 100, BLU.AID.PomCure);
        DefineSimpleGCD(res, Track.Gobskin, "Gobskin", "Gobskin", 100, BLU.AID.Gobskin, 30);
        DefineSimpleGCD(res, Track.Avail, "Avail", "Avail", 100, BLU.AID.Avail, 12);
        DefineSimpleGCD(res, Track.FrogLegs, "Frog Legs", "F.Legs", 10, BLU.AID.FrogLegs);
        DefineSimpleGCD(res, Track.Whistle, "Whistle", "Whistle", 100, BLU.AID.Whistle, 30);
        DefineSimpleGCD(res, Track.Cactguard, "Cactguard", "CactG.", 100, BLU.AID.Cactguard, 6);
        DefineSimpleGCD(res, Track.AngelWhisper, "Angel Whisper", "A.Whisper", 100, BLU.AID.AngelWhisper);
        DefineSimpleGCD(res, Track.Exuviation, "Exuviation", "Exuvi", 100, BLU.AID.Exuviation);
        DefineSimpleGCD(res, Track.ColdFog, "Cold Fog", "C.Fog", 50, BLU.AID.ColdFog, 5);
        DefineSimpleGCD(res, Track.Stotram, "Stotram (Heal)", "Stotram", 100, BLU.AID.Stotram2);
        DefineSimpleGCD(res, Track.AngelsSnack, "Angels Snack", "A.Snack", 100, BLU.AID.AngelsSnack, 15);
        DefineSimpleGCD(res, Track.ChelonianGate, "Chelonian Gate", "C.Gate", 100, BLU.AID.ChelonianGate, 10);
        DefineSimpleGCD(res, Track.BasicInstinct, "Basic Instinct", "Instinct", 10, BLU.AID.BasicInstinct);
        DefineSimpleGCD(res, Track.DragonForce, "Dragon Force", "D.Force", 100, BLU.AID.DragonForce, 15);
        DefineSimpleGCD(res, Track.Schiltron, "Schiltron", "Schilt", 100, BLU.AID.Schiltron, 15);
        DefineSimpleGCD(res, Track.Rehydration, "Rehydration", "Rehyd.", 100, BLU.AID.Rehydration);
        DefineSimpleGCD(res, Track.ForceField, "Force Field", "F.Field", 100, BLU.AID.ForceField, 10);

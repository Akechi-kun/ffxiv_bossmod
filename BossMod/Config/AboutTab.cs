...
public sealed class AboutTab(DirectoryInfo? replayDir)
{
    ...
    public void DrawNote(string note, string note2 = "")
    {
    ...
    public void DrawWarning(string warning, string warning2 = "")
    {
    ...
    public void Draw()
    {
        ...
        if (ThreadLoadImageHandler.TryGetTextureWrap(overviewPath, out var overview))
        {
            ...
            {
                ImGui.Image(overview.ImGuiHandle, new Vector2(400f.Scale(), 100f.Scale()));
            });
        }
        ...
        if (ThreadLoadImageHandler.TryGetTextureWrap(radarPath, out var radar))
        {
            ...
            {
                ImGui.Image(radar.ImGuiHandle, new Vector2(400f.Scale(), 100f.Scale()));
            });
        }
        ...
        if (ThreadLoadImageHandler.TryGetTextureWrap(autorotPath, out var autorot))
        {
            ...
            {
                ImGui.Image(autorot.ImGuiHandle, new Vector2(400f.Scale(), 100f.Scale()));
            });
        }
        ...
        if (ThreadLoadImageHandler.TryGetTextureWrap(cdpPath, out var cdp))
        {
            ...
            {
                ImGui.Image(cdp.ImGuiHandle, new Vector2(400f.Scale(), 100f.Scale()));
            });
        }
        ...
        if (ThreadLoadImageHandler.TryGetTextureWrap(aiPath, out var ai))
        {
            ...
            {
                ImGui.Image(ai.ImGuiHandle, new Vector2(400f.Scale(), 100f.Scale()));
            });
        }
        ...
        if (ThreadLoadImageHandler.TryGetTextureWrap(replaysPath, out var replays))
        {
            ...
            {
                ImGui.Image(replays.ImGuiHandle, new Vector2(400f.Scale(), 100f.Scale()));
            });
        }
        ...
        if (ThreadLoadImageHandler.TryGetTextureWrap(contributorPath, out var contributor))
        {
            ...
            {
                ImGui.Image(contributor.ImGuiHandle, new Vector2(400f.Scale(), 100f.Scale()));
            });
        }
